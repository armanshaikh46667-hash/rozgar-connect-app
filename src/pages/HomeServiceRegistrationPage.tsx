    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="bg-gradient-to-br from-primary via-primary to-accent-foreground px-6 pt-8 pb-6 text-primary-foreground">
          <div className="max-w-lg mx-auto"><h1 className="text-xl font-extrabold flex items-center gap-2"><Home size={22} /> घरेलू सेवाएँ</h1></div>
        </div>
    ...
    <div className="min-h-screen bg-background">
      <div className="bg-gradient-to-br from-primary via-primary to-accent-foreground px-6 pt-8 pb-6 text-primary-foreground">
        <div className="max-w-lg mx-auto">
          ...
          <h1 className="text-xl font-extrabold flex items-center gap-2"><Home size={22} /> घरेलू सेवाएँ रजिस्ट्रेशन</h1>
          <p className="text-primary-foreground/80 text-xs mt-1">दर्जी, ब्यूटी पार्लर, कुक, ट्यूटर आदि</p>
        </div>
      </div>
      <div className="max-w-lg mx-auto px-4 -mt-4 relative z-10">
        <div className="bg-card rounded-2xl shadow-lg border border-border p-5">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={serviceCharge} onChange={(e) => setServiceCharge(e.target.value)} placeholder="जैसे: ₹200/विज़िट" className={`${inputClass} mt-2`} maxLength={50} />
            </div>
            <div>
